...
def setup_training_loop_kwargs(
    ...
    if snap is None:
        snap = 50
        print("Snap set to {} by default".format(snap))
    else:
        print("Snap set to {}".format(snap))
    ...
    cfg_specs = {
        'low_shot':  dict(ref_gpus=-1, kimg=300,    mb=8,  mbstd=4,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=2),
...
# General options.
@click.option('--outdir', help='Where to save the results', default='out/', required=True, metavar='DIR')
...
# Dataset.
@click.option('--data', help='Training data (directory or zip)', default='https://data-efficient-gans.mit.edu/datasets/100-shot-obama.zip', metavar='PATH', required=True)
